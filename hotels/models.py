...
class Hotel(SafeDeleteModel):
    ...
    class Meta:
        ...
        # constraints = [models.UniqueConstraint(fields=["name"], condition=models.Q(deleted=None))]
...
class Classification(SafeDeleteModel):
    ...
    name = models.CharField(max_length=255, choices=CLASS_CHOICES, default='grand')
...
class Room(SafeDeleteModel):
    ...
    def get_price(self):
        price = self.price if self.price else self.classification.price
        return price
